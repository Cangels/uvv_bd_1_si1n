...
GRANT ALL ON DATABASE uvv TO joao_rafael;
...
CREATE SCHEMA hr
AUTHORIZATION joao_rafael;


SELECT CURRENT_SCHEMA();
SHOW SEARCH_PATH;
SET SEARCH_PATH TO hr, "$user", public;
ALTER USER joao_rafael
SET SEARCH_PATH TO hr, "$user", public;
SET SEARCH_PATH TO hr, "joao_rafael", public;
...
COMMENT ON COLUMN hr.cargos.id_cargo IS 'PK dos cargos.';
COMMENT ON COLUMN hr.cargos.cargo IS 'Tipos de cargos.';
COMMENT ON COLUMN hr.cargos.salario_minimo IS 'Salário minímo que o cargo oferece.';
COMMENT ON COLUMN hr.cargos.salario_maximo IS 'Salário máximo que consegue no cargo citado.';
...
COMMENT ON TABLE hr.regioes IS 'Aqui nessa tabela informará as regiões e seus ID''s';
COMMENT ON COLUMN hr.regioes.id_regiao IS 'Aqui será informado o ID.';
...
COMMENT ON COLUMN hr.paises.id_pais IS 'Aqui terá uma PK do ID do país.';
COMMENT ON COLUMN hr.paises.nome IS 'Nome dos países.';
COMMENT ON COLUMN hr.paises.id_regiao IS 'Aqui será informado o ID da tabela regiões.';
...
COMMENT ON TABLE hr.localizacoes IS 'Tabela com as localizações mais específicas.';
COMMENT ON COLUMN hr.localizacoes.id_localizacao IS 'PK da tabela, sendo o ID da localização.';
COMMENT ON COLUMN hr.localizacoes.endereco IS 'Endereço da localização(rua e número).';
COMMENT ON COLUMN hr.localizacoes.cep IS 'CEP da localização.';
COMMENT ON COLUMN hr.localizacoes.cidade IS 'Cidade informada.';
COMMENT ON COLUMN hr.localizacoes.uf IS 'Estado abreviado onde se encontra a empresa.';
COMMENT ON COLUMN hr.localizacoes.id_pais IS 'FK da tabela países.';
...
COMMENT ON COLUMN hr.departamentos.id_departamento IS 'PK dos departamentos.';
COMMENT ON COLUMN hr.departamentos.nome IS 'Nome dos departamentos.';
COMMENT ON COLUMN hr.departamentos.id_localizacao IS 'PK da tabela, sendo o ID da localização.';
COMMENT ON COLUMN hr.departamentos.id_gerente IS 'Uma FK que faz um relacionamento com a PK de empregados. Para poder fazer uma conexão entre empregados e departamentos.';
...
COMMENT ON COLUMN hr.empregados.id_empregado IS 'PK dos empregados com identificação com o ID deles.';
COMMENT ON COLUMN hr.empregados.nome IS 'Nome e sobrenome dos empregados.';
COMMENT ON COLUMN hr.empregados.email IS 'E-mail dos empregados.';
COMMENT ON COLUMN hr.empregados.telefone IS 'Telefone dos empregados.';
COMMENT ON COLUMN hr.empregados.data_contratacao IS 'Data de contratação dos empregados.';
COMMENT ON COLUMN hr.empregados.id_cargo IS 'FK  da tabela cargos.';
COMMENT ON COLUMN hr.empregados.salario IS 'Salário dos empregados.';
COMMENT ON COLUMN hr.empregados.comissao IS 'Comissão será apenas para os  vendedores.';
COMMENT ON COLUMN hr.empregados.id_departamento IS 'PK dos departamentos, que faz uma FK na tabela de empregados.';
COMMENT ON COLUMN hr.empregados.id_supervisor IS 'Esse auto-relacionamento existe, para que quando iremos fazer um join and CONNECT BY query.';
...
COMMENT ON TABLE hr.historico_cargos IS 'Histórico dos empregados com inicio e final de atuação em seu cargos.';
COMMENT ON COLUMN hr.historico_cargos.id_empregado IS 'PK dos empregados com identificação com o ID deles.';
COMMENT ON COLUMN hr.historico_cargos.data_inicial IS 'Data de inicio no cargo.';
COMMENT ON COLUMN hr.historico_cargos.data_final IS 'Data de saída do cargo.';
COMMENT ON COLUMN hr.historico_cargos.id_cargo IS 'PK dos cargos.';
COMMENT ON COLUMN hr.historico_cargos.id_departamento IS 'FK dos historico dos cargos, fazendo referência a PK de departamentos.';
